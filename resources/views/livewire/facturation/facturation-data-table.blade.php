<div>
    ...
    <x-bloc-content>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
            <div>
                <x-input label="Rechercher" icon="magnifying-glass" wire:model.live="search" />
            </div>
            <div>
                <x-native-select
                    label="Acquittée"
                    ...
                    <x-datatable.tr>
                        ...
                        <x-datatable.td>
                            <div class="flex space-x-2">
                                ...
                                @endif
                                @if($facture->statut !== \App\Enum\BillStatut::CREATED)
                                    <button wire:click="toggleAcquitte({{$facture}})" type="button" class="rounded-full bg-indigo-600 p-1 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                        ...
                        <x-datatable.td>
                            ...
                            <x-button label="Liste des courses" icon="list-bullet" primary sm href="{!! route('admin.facturations.edition', [
