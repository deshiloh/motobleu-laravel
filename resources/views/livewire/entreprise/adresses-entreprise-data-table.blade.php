                ...
                <x-datatable.tr>
                    ...
                    <x-datatable.td>
                        <div class="flex space-x-2">
                            <x-mini-button icon="pencil" primary href="{{ route('admin.entreprises.adresses.edit', ['adress' => $adresse->id, 'entreprise' => $entreprise]) }}" />
                            <x-mini-button icon="trash" red wire:click="deleteAddress({{ $adresse }})"/>
                        </div>
                    </x-datatable.td>
                </x-datatable.tr>
            @empty
