                ...
                <div class="flex h-16 justify-between">
                    <div class="flex">
                        <div class="hidden sm:ml-6 sm:flex sm:space-x-4 2xl:space-x-8">
                            @guest
                                <x-front.menu.item href="{{ route('front.home') }}">
                                    <x-slot:icon>
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:items-center">
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="space-x-2">
                                <a href="{{ route('switch.local', ['locale' => 'fr']) }}"><span class="fi fi-fr"></span></a>
                                <a href="{{ route('switch.local', ['en']) }}"><span class="fi fi-gb"></span></a>
                            </div>
