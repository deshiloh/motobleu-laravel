<div>
                ...
                <x-datatable.tr>
                    ...
                    <x-datatable.td>
                        <div class="flex space-x-2">
                            <x-mini-button rounded icon="pencil" info href="{{ route('admin.localisations.edit', ['localisation' => $localisation->id]) }}" />
                            <x-mini-button rounded icon="trash" red wire:click="toggleStatus({{ $localisation }})" />
                        </div>
                    </x-datatable.td>
                </x-datatable.tr>
            @empty
    ...
    <x-front.pagination :pagination="$localisations" :perPage="$perPage" />
</div>
