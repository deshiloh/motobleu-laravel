                ...
                <div class="flex h-16 justify-between">
                    <div class="flex">
                        <div class="hidden sm:ml-6 sm:flex sm:space-x-4 2xl:space-x-8">
                            ...
                            <x-front.menu.item href="{{ route('front.home') }}" :active="in_array(\Illuminate\Support\Facades\Route::currentRouteName(), ['front.dashboard', 'front.home'])">
                                <x-slot:icon>
                            ...
                            @auth
                                <x-front.menu.item href="{{ route('admin.homepage') }}">
                                    <x-slot:icon>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                ...
                                <x-front.menu.item :active="in_array(\Illuminate\Support\Facades\Route::currentRouteName(), ['front.passager.list', 'front.passager.create'])" href="{{ route('front.passager.list') }}">
                                    <x-slot:icon>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
