<div x-data="wireui_datetime_picker({
    ...
    <div class="fixed inset-0 z-20 overflow-y-auto sm:absolute sm:inset-auto sm:top-10 sm:mt-1 sm:right-0"
        ...
        <div class="flex items-end justify-center min-h-screen sm:h-96 sm:items-start"
            ...
            <div class="w-full rounded-t-md border bg-base-100 shadow-lg
                        border-base-300 transition-all relative
                ...
                <div x-show="tab === 'date'" class="space-y-5">
                    @unless ($withoutTips)
                        <div class="grid grid-cols-3 gap-x-2 text-center text-secondary-600">
                            <x-dynamic-component
                                ...
                                class="bg-base-100 border-none hover:bg-base-200"
                    ...
                    <div class="flex items-center justify-between">
                        <x-dynamic-component
                            :component="WireUi::component('button')"
                            class="rounded-lg shrink-0 hover:bg-base-200"
                            x-show="!monthsPicker"
                        ...
                        <div class="w-full flex items-center justify-center gap-x-2 text-secondary-600 dark:text-secondary-500">
                            ...
                            <input class="w-10 sm:w-14 appearance-none p-0 ring-0 border-none focus:ring-0 focus:outline-none bg-base-100"
                                   x-model="year"
                            ...
                            <template
                                ...
                                <div class="flex justify-center picker-days">
                                    <button class="text-sm w-7 h-6 focus:outline-none rounded-md focus:ring-2 focus:ring-ofsset-2 focus:ring-primary-600
                                                 hover:bg-base-200 disabled:cursor-not-allowed"
                                        :class="{
                                            'text-accent-content/60': !date.isDisabled && !date.isSelected && date.month === month,
                                            'text-accent-content/20': date.isDisabled || date.month !== month,
                                            'text-white border border-accent-content': date.isToday && !date.isSelected,
                                            'text-accent-content font-semibold border border-accent-content': date.isSelected
                                        }"
